  ...
  return (
    <>
      ...
      <div className='flex flex-col flex-wrap items-center w-5/6'>
        <ParagraphBox className = {""}content={`This project is a full stack web IoT app that tracks the moisture content of plants.
...
Node red provides an API for next JS to query to render the plant profile pages.
`}/>
