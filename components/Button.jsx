...
export default function Button({variant = "primary", className = "",content = "",...props}) {
  ...
  const variants = {
    ...
    "secondary": "text-green-800 bg-white px-3 font-extrabold w-48 text-center p-1 m-2 transition hover:text-white hover:bg-green-800 duration-100 hover:border-solid hover:border-white border-2 hover:scale-105",
